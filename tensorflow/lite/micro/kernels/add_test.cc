...
const int32_t broadcast_input1_shape[] = {4, 2, 3, 1, 2};
...
void ValidateAddGoldens(TfLiteTensor* tensors, int tensors_size,
  ...
  const TfLiteRegistration* registration = tflite::ops::micro::Register_ADD();
...
void TestAddFloat(const int32_t* input1_dims_data, const float* input1_data,
                  const int32_t* input2_dims_data, const float* input2_data,
                  const int32_t* output_dims_data, const float* expected_output,
...
template <typename T>
void TestAddQuantized(const int32_t* input1_dims_data, const float* input1_data,
                      T* input1_quantized, float input1_scale,
                      int input1_zero_point, const int32_t* input2_dims_data,
...
TF_LITE_MICRO_TEST(FloatAddNoActivation) {
  ...
  const int32_t inout_shape[] = {4, 1, 2, 2, 1};
...
TF_LITE_MICRO_TEST(FloatAddVariousInputShapes) {
  ...
  const int32_t test_shapes[num_shapes][max_shape_size] = {
      {1, 6},
      {2, 2, 3},
      {3, 2, 1, 3},
      {4, 1, 3, 1, 2},
...
TF_LITE_MICRO_TEST(QuantizedAddNoActivationUint8) {
  ...
  const int32_t zero_points[] = {125, 129, 135};
  const int output_dims_count = 4;
  const int32_t inout_shape[] = {4, 1, 2, 2, 1};
...
TF_LITE_MICRO_TEST(QuantizedAddNoActivationInt8) {
  const float scales[] = {0.25, 0.5, 1.0};
  const int32_t zero_points[] = {-10, 4, 13};
  const int output_dims_count = 4;
  const int32_t inout_shape[] = {4, 1, 2, 2, 1};
  const float input1_values[] = {-2.01, -1.01, -0.01, 0.98};
  const float input2_values[] = {1.01, 1.99, 2.99, 4.02};
...
TF_LITE_MICRO_TEST(QuantizedAddVariousInputShapesInt8) {
  const float scales[] = {0.1, 0.05, 0.1};
  const int32_t zero_points[] = {-9, 5, 14};
  const int output_dims_count = 6;
...
TF_LITE_MICRO_TEST(QuantizedAddWithScalarBroadcastUint8) {
  ...
  const int32_t zero_points[] = {120, 131, 139};
...
TF_LITE_MICRO_TEST(QuantizedAddWithScalarBroadcastFloat) {
  const float scales[] = {0.1, 0.05, 0.1};
  const int32_t zero_points[] = {127, 131, 139};
...
TF_LITE_MICRO_TEST(QuantizedAddWithScalarBroadcastInt8) {
  ...
  const int32_t zero_points[] = {-8, 4, 12};
...
TF_LITE_MICRO_TEST(QuantizedAddWithMixedBroadcastInt8) {
  const float scales[] = {0.1, 0.05, 0.1};
  const int32_t zero_points[] = {-10, -5, 7};
